...
<CheckBox Name="WPFTweaksDisableMicrosoftAccountLogin" Content="Disable Microsoft Account Login" Margin="5,0"  ToolTip="Disables new logins into Microsoft Accounts, so you can use local accounts in peace"/>
